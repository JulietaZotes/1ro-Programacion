...
var cantidadDados = rls.questionInt("Ingrese cuantos dados quiere tirar: ");
var probabilidad = Math.pow(6, cantidadDados);
console.log("La probabilidad de sacar todas las caras 6 es de: 1/".concat(probabilidad));
